...
public class DataMoveDao {
	...
	public int insertDataTemp(List<List<Object>> listob) {
		 String insertsqlTemp = "INSERT INTO cmtp_temp (cardcode , remark ,  IMSI, ICCID, userStatus, cardStatus, gprsUsed, messageUsed,"
						...
						public void setValues(PreparedStatement ps, int i) {
							try {
								// 并根据数据类型对Statement 中的占位符进行赋值
									...
									ps.setDate(9, Date.valueOf(String.valueOf(valueList.get(8))));
