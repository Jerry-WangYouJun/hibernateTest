            ...
            if (!plugin.settings.always_visible) {
                ...
                if (!update) {
                    ...
                    if (plugin.settings.show_icon) {
                        ...
                        var html = '<button type="button" class="Zebra_DatePicker_Icon' + ($element.attr('disabled') == 'disabled' ? ' Zebra_DatePicker_Icon_Disabled' : '') + '">选择日期</button>';
        ...
        plugin.show = function() {
            ...
            if (!plugin.settings.always_visible) {
                ...
                var
                    ...
                    left = plugin.settings.offset[0],
				    top = plugin.settings.offset[1],
